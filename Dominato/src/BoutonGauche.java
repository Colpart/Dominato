...
public class BoutonGauche extends JButton implements MouseListener{
	...
	public BoutonGauche(String icone, Panneau panneau){
		super();
		info = icone;
	...
	public void mousePressed(MouseEvent arg0) {
		this.panneau.bougerPlateauVersLaGauche();
